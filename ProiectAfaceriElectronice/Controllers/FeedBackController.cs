...
namespace ProiectAfaceriElectronice.Controllers
{
    ...
    {
        private readonly IFeedBack _prodRepo;

        public FeedBackController(IFeedBack produsRepo)
        {
            _prodRepo = produsRepo;
        }

        [HttpGet]
        public async Task<ActionResult<IEnumerable<Feedbackproduse>>> GetProduse()
        {
            try
            {
        ...
        [HttpGet("search/{den}")]
        public async Task<ActionResult<Feedbackproduse>> GetProdByName(string den)
        {
            try
            {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Feedbackproduse>> GetProdById(int id)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<Feedbackproduse>> CreateProdus([FromBody] Feedbackproduse prod)
        {
            try
            {
                if (prod == null)
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<Feedbackproduse>> UpdateProd(int id, [FromBody] Feedbackproduse prod)
        {
            try
            {
                if (id != prod.Idprodus)
